...
\DeclareMathOperator{\A}{\mathbb{A}}                   % Set of Algebraic Numbers
...
\DeclareMathOperator{\chara}{char}                         % Characteristic
...
\DeclareMathOperator{\Cont}{Cont}                       % Content
\DeclareMathOperator{\Ga}{Gal}                           % Galois Group
...
\fancyhead[L]{Some Notes about Abstract Algebra}
\fancyhead[R]{MATH2401-01}
\fancyfoot[C]{Page.\thepage}

\title{{\huge 抽象代数} \\ Abstract Algebra}
